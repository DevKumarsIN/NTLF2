...
const TicketsSection = () => {
  ...
  useEffect(() => {
    ...
    // TICKET SCROLL ANIMATION - COMMENTED OUT (uncomment to enable)
    ...
    // STATIC DISPLAY - Currently Active (Show all tickets without animation)
    const ticketStack = ticketStackRef.current;
    if (ticketStack) {
      const cards = ticketStack.querySelectorAll('.ticket-card');
      cards.forEach((card, idx) => {
        ...
        card.style.transform = 'translateX(0)';
        card.style.position = 'relative';
        card.style.transition = 'none'; // Remove animation
      });
    }
  ...
  const tickets = [
    { id: 1, image: "images/event-ticket-11.webp", alt: "Ticket Type 1" },
    { id: 2, image: "images/event-ticket-22.png", alt: "Ticket Type 2" },
    { id: 3, image: "images/event-ticket-33.webp", alt: "Ticket Type 3", link: "https://in.explara.com/e/ntlf2026?t=1" },
    { id: 4, image: "images/event-ticket-44.webp", alt: "Ticket Type 4", link: "https://in.explara.com/e/ntlf2026?t=1" },
    { id: 5, image: "images/event-ticket-55.webp", alt: "Ticket Type 5", link: "https://in.explara.com/e/ntlf2026?t=1" }
  ];

  return (
    <section id="ticket" className="dark-section container-fluid py-1 py-sm-5 text-white py-4">
      <div className="m-0 dark-section">
        <div className="dark-section row mb-4 ps-lg-5 tickets-heading-section">
          <div className="col-12 text-center">
            {/* animated-tickets-h2 */}
            <h2 className="display-5 fw-bold text-light text-start ">
        ...
        <div className="row ticket-row g-1 text-center justify-content-center"  ref={ticketStackRef}>
          {tickets.map((ticket, index) => (
            <div 
              key={ticket.id}
              className="col-6 col-md-4 col-lg-2 ticket-card"
              style={{ 
                // opacity: 1, 
        ...
        {/* Discount section */}
        <div className='dark-section px-1 px-sm-5'>
         
        <div className="dark-section container p-4 my-sm-5 my-3 px-lg-5 px-2 discount-section" style={{ border: '1px solid #fff', borderRadius: '35px' }}>
          
          <div className="dark-section row justify-content-center align-items-start position-relative">
            <div className="col-md-6 col-12 d-flex flex-column align-items-center justify-content-start">
              {/* animated-discount */}
              <h5 
                className="open-sans offer-headings fw-bold mb-3 text-light "
                style={{ 
                  display: 'flex', 
                  alignItems: 'center', 
                  gap: '0.6em', 
              ...
              {/* animated-discount */}
              <ul className="open-sans offer-ticket-li offer-ticket-margin " style={{ textAlign: 'start' }}>
                <li><span>5-15</span> <span>Registrations:</span> <span>10%</span> <span>Discount</span></li>
                <li><span>16-25</span> <span>Registrations:</span> <span>15%</span> <span>Discount</span></li>
                <li><span>Above 25</span> <span>Registrations:</span> <span>20%</span> <span>Discount</span></li>
              </ul>
            </div>
            {/* Vertical divider */}
            <div 
            ...
            />
            <div className="offer-section col-md-6 col-12 d-flex flex-column align-items-center justify-content-start">
              {/* animated-discount */}
              <h5 
                className="open-sans offer-headings fw-bold mb-3 text-light "
                style={{ 
              ...
              {/* animated-discount */}
              <h5 className="offer-ticket-margin-right open-sans special-pricing"><span>Special</span> <span>Pricing</span> <span>For:</span></h5>
              {/* animated-discount */}
              <ul className="open-sans offer-ticket-li offer-ticket-margin-right" style={{ textAlign: 'start' }}>
                <li><span>Startups </span></li>
                <li><span>SME</span></li>
                <li><span>Women</span> <span>Leaders</span></li>
                  <li><span>Foreign</span> <span>Delegations</span></li>
              </ul>
            </div>
          </div>
         
          {/* animated-discount */}
          <h5 className="pt-4 open-sans offer-mail text-center ">
            <span>To</span> <span>avail</span> <span>these</span> <span>offers,</span> <span>write</span> <span>to</span> <span>us</span> <span>at :</span>
            <img 
              src="images/white-mail.png" 
              alt="Email Icon" 
              style={{ width: '22px', height: '22px', margin: '0 6px 1px 6px', verticalAlign: 'middle' }}
            />
            <a href="mailto:events@nasscom.in" style={{ textDecoration: 'none', color: '#fff' }} className="">
        ...
        {/* Terms & Conditions */}
       {/* animated-terms-heading */}
        <div className="dark-section container py-1 terms-heading-section px-sm-5 px-2" >
          <h5 className="montserrat terms-ticket text-left  text-light ">
            <span>Terms</span> <span>&</span> <span>Conditions:</span>
          </h5>
        </div>
         <div className='px-1 px-sm-5'>
        <div className="dark-section container p-lg-5 p-3 px-lg-5 px-2 my-sm-5 my-3" style={{ border: '1px solid #fff', borderRadius: '35px' }}>
          <div className="pt-1 row justify-content-start">
            <div className="col-12">
              {/* animated-terms-ul */}
              <ul className="terms-ticket-li ">
                <li>
