...
const PillarsSection = () => {
      ...
      const renderStack = (progress) => {
        ...
        cards.forEach((card, i) => {
          ...
          if (progress > MAX_INDEX && i === MAX_INDEX) {
            ...
            scale = 1 + (overlapProgress * 0.1); // Slightly scale up
            opacity = 1;
  ...
  return (
    <>
      <section className="container-fluid mb-lg-0 p-4 p-lg-5 pillars-heading-section" style={{ paddingBottom: window.innerWidth < 992 ? '10px' : 'inherit' }}>
      ...
      <section 
        className="piller-section-main container-fluid px-3" 
